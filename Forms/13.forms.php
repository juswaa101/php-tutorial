<?php
    /*
        16. PHP Forms
        - The PHP superglobal variables are used to collect form data after submitting an HTML form.
        - The PHP $_GET and $_POST superglobals are used to collect form data.
